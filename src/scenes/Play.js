class Play extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.spritesheet('rocket', './assets/rocket.png', {frameWidth: 40, frameHeight: 128, startFrame: 0, endFrame: 3});
      this.load.image('spaceship', './assets/spaceship.png');
      this.load.spritesheet('smallrocket', './assets/smallrocket.png', {frameWidth: 37, frameHeight: 37, startFrame: 0, endFrame: 2});
      ...
      // load spritesheet
      this.load.spritesheet('explosion', './assets/explosion.png', {frameWidth: 128, frameHeight: 128, startFrame: 0, endFrame: 4});
    }
    create() {
        // place tile sprite
        this.sky = this.add.tileSprite(0, 0, 640, 480, 'sky').setOrigin(0, 0);
        this.fence = this.add.tileSprite(0, 0, 640, 480, 'fence').setOrigin(0, 0);
       ...
       // this.add.rectangle(0, borderUISize + borderPadding, game.config.width, borderUISize * 2, 0x00FF00).setOrigin(0, 0);
        ...
        // add spaceships (x3)
        this.smallship = new Spaceship(this, game.config.width + borderUISize * 6, borderUISize *2, 'smallrocket', 0, 50, 2).setOrigin(0,0);
